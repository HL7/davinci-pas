...
* §conf-6^payer:PA Intermediary Systems **MAY** generate an error if a data element that is marked as Must Support is sent as support for a type of authorization request that they are *NOT* capable of processing.§
