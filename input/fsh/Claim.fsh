...
* careTeam ^slicing.discriminator.path = "extension('http://example.org/fhir/fish/StructureDefinition/care-team-claim-scope').value as boolean"
...
* careTeam[OverallClaimMember].extension[careTeamClaimScope].valueBoolean 0..1
* careTeam[OverallClaimMember].extension[careTeamClaimScope].valueBoolean = true
* careTeam[ItemClaimMember].extension[careTeamClaimScope].valueBoolean 0..1
